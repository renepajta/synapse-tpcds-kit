CREATE MATERIALIZED VIEW q4_View3 WITH (DISTRIBUTION = HASH([Expr0])) AS
SELECT  [DemoDW].[tpcds].[customer].[c_customer_id]         AS [Expr0]
       ...
       ,SUM(([DemoDW].[tpcds].[store_sales].[ss_ext_list_price]-[DemoDW].[tpcds].[store_sales].[ss_ext_wholesale_cost]-[DemoDW].[tpcds].[store_sales].[ss_ext_discount_amt]+[DemoDW].[tpcds].[store_sales].[ss_ext_sales_price])/(2.)) AS [Expr8]
       ,COUNT_BIG(([DemoDW].[tpcds].[store_sales].[ss_ext_list_price]-[DemoDW].[tpcds].[store_sales].[ss_ext_wholesale_cost]-[DemoDW].[tpcds].[store_sales].[ss_ext_discount_amt]+[DemoDW].[tpcds].[store_sales].[ss_ext_sales_price])/(2.)) AS [Expr9]
